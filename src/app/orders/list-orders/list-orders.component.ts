...
export class ListOrdersComponent implements OnInit {
  ...
  handleGetOrdersByShops(formValue) {
    if (formValue) {
    ...
    } else if (this.dateFilter.from && this.dateFilter.to) {
      this.handleDateFilter(this.dateFilter.from, this.dateFilter.to);
    } else {
      this.getOrders();
    }
  }
